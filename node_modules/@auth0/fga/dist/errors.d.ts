...
import { AuthErrorCode, ErrorCode, InternalErrorCode, NotFoundErrorCode, ResourceExhaustedErrorCode } from "./apiModel";
/**
 *
 * @export
 * @class FgaError
...
export declare class FgaApiRateLimitExceededError extends FgaApiError {
    name: string;
    apiErrorCode: ResourceExhaustedErrorCode;
    rateLimit?: number;
    rateUnit?: string;
 ...
 * @extends { FgaValidationError }
 */
export declare class FgaInvalidEnvironmentError extends FgaValidationError {
    name: string;
