...
exports.FgaInvalidEnvironmentError = exports.FgaRequiredParamError = exports.FgaValidationError = exports.FgaApiAuthenticationError = exports.FgaApiInternalError = exports.FgaApiRateLimitExceededError = exports.FgaApiNotFoundError = exports.FgaApiValidationError = exports.FgaApiError = exports.FgaError = void 0;
/**
 *
 * @export
 * @class FgaError
...
function getMaximumRateUnit(api) {
    switch (api) {
        case "check":
        case "read":
        case "write":
 ...
 * @extends { FgaValidationError }
 */
class FgaInvalidEnvironmentError extends FgaValidationError {
    constructor(field, allowedEnvironments) {
        super(field, allowedEnvironments
            ? `environment is required and must be one of the following: ${allowedEnvironments.join(", ")}`
            : undefined);
        this.name = "FgaInvalidEnvironmentError";
    }
}
exports.FgaInvalidEnvironmentError = FgaInvalidEnvironmentError;
